...
# 사용 예시
def generate_comment_video(comments_file, output_file):
    generator = CommentVideoGenerator(width=550, height=1080)
    ...
    # 비디오 생성
    generator.create_video(output_file)


# 실행
generate_comment_video('comment.txt', 'output_comments.mp4')